    ...
    <div className="footer2Container">
      ...
      <div className="footer2Contant row">
        <div className="fotter2InnterContant col-5 mb-4 col-md-3">
          ...
          <p>Honda Activa for rent in Pune</p>
          <p>any Royal Enfield 350 for rent in Pune</p>
          <p>Bikes for rent in Aurangabad</p>
        ...
        <div className="fotter2InnterContant col-5 mb-4 col-md-3">
          ...
          <p>Yamaha FZ S for rent in Pune</p>
          <p>Bajaj Avenger Cruise 220 for rent in Pune</p>
        ...
        <div className="fotter2InnterContant col-5 mb-4 col-md-3">
          ...
          <p>Bajaj Pulsar 150 for rent in Pune</p>
          <p>Bajaj Dominar 400 ABS for rent in Pune</p>
        ...
        <div className="fotter2InnterContant col-5 mb-4 col-md-3">
          ...
          <p>Honda Dio for rent in Pune</p>
          <p>Bikes for rent in Mumbai</p>
          <p>Bikes for rent in Nagpur</p>
          <p>Bikes for rent in Pune</p>
        </div>
      </div>
    </div>
  );
